...
int main(int _argc, char *_argv[]) 
{
    ...
    SoftBody simpleSquare = CreateSquare(sq_particles, sq_springs, 450, 250, 50, 10, DEFAULT_SPRING_STIFFNESS, 2, false);
    ...
    while (!WindowShouldClose())
    {
        ...
        UpdateSoftBody(&simpleSquare, dt);
